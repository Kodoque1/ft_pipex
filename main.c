...
/* DONE Handle fork procedure
 * DONE Child 1 : handle file input
 * DONE Child 1 : handle pipe output
 * DONE Child 2 : handle pipe input
 * DONE TESTED Child 2 : handle file output
 * DONE Construct from path
 * DONE execve
 * testing
 * function splitting
 * file splitting
